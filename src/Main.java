	...
	public void start() {
		try {
			...
			String address = "http://openapi.naver.com/search?key=41e7b6581f7c9d85d41271a9033527d1&query="
					+ query + "&target=news&start=1&display=20";
...
//				line += "$";
	...
	public void excelInput(){
		...
		for(int i = 0; i < resultString.size(); i++){
			...
			map.put("link", lines[3]);
			map.put("date", lines[2]);
			
			map.put("description", lines[1]);
